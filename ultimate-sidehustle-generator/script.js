	...
	function coolSideHustle() {
		...
		var thing = ["hot dog", "dog", "cat", "jewelry", "handicrafts", "cupcake", "computer", "money", "crochet", "online", "toys", "comic", "book", "house", "hair", "webcam", "pickle"];
		var doer = ["processor", "maker", "washer", "purveyor", "seller", "marketer", "programmer", "taster", "concierge", "curator", "accountant", "manager", "inspector", "moderator", "advisor"];
